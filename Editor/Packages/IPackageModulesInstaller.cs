...
namespace RealityCollective.ServiceFramework.Editor.Packages
{
    ...
    /// if the <see cref="SupportedServiceModuleType"/> matches.
    /// </summary>
    public interface IPackageModulesInstaller
    {
        ...
        /// </summary>
        /// <param name="serviceConfiguration">The <see cref="ServiceConfiguration"/> containing
        /// the configured <see cref="IServiceModule"/>.</param>
        /// <returns><c>true</c>, if the module was approved and installed.</returns>
